...
<body>
  <!--<div id="clouds" style="padding-top:14px;">-->
    <div class="head1" style="padding-top: 100px; padding-bottom: 0px;padding-right:400px;">
 ...
 <h2>Register</h2>
      ...
      <div> <p style="color: black; font-size: 19px"> Already have an account? <a style=" color: blue; font-weight: bold" href ="login.php"> Login </a> </div>
