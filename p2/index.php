...
<header>
  ...
  <div class="head1" style="padding-top: 5px;">
...
<section>
  ...
  <div id="login">
    ...
    <form name="f2" action="" onsubmit = "return validation()"  method="post">
        <table>
            <tr>
            <td>Name:<input type="text"  id="name" name="name" placeholder="Full Name" required pattern="[A-Z* 0-9*]{1,}" title="Enter your Name"></td>
            ...
            <tr>
              <div>
                <h3 id="center_main_text" class="hover"></h3>
              <p style="text-align-center;">
            <td>Subject 1:<input type="text"  id="sub1" name="sub1" required pattern="[A-Z* a-z*]{1,20}" title="Enter Subject1, MAX 20"></td>
            <tr>
              <br>
            </tr>
            <td>Marks:<input type="text"  id="mrk1" name="mrk1" required pattern="[0-9]{1,3}" title="Enter Marks between 0-100"></td>
            </tr>
            <tr>
            <td>Subject 2:<input type="text"  id="sub2" name="sub2" required pattern="[A-Z* a-z*]{1,20}" title="Enter Subject2, MAX 20"></td>
            <tr>
            <td>Marks:<input type="text"  id="mrk2" name="mrk2" required pattern="[0-9]{1,3}" title="Enter Marks between 0-100"></td>
            </tr>
            <tr>
            <td>Subject 3:<input type="text"  id="sub3" name="sub3" required pattern="[A-Z* a-z*]{1,20}" title="Enter Subject3, MAX 20"></td>
            <tr>
            <td>Marks:<input type="text"  id="mrk3" name="mrk3" required pattern="[0-9]{1,3}" title="Enter Marks between 0-100"></td>
            </tr>
            <tr>
            <td>Subject 4:<input type="text"  id="sub4" name="sub4" required pattern="[A-Z* a-z*]{1,20}" title="Enter Subject4, MAX 20"></td>
            <tr>
            <td>Marks:<input type="text"  id="mrk4" name="mrk4" required pattern="[0-9]{1,3}" title="Enter Marks between 0-100"></td>
            </tr>
            <tr>
            <td>Subject 5:<input type="text"  id="sub5" name="sub5" required pattern="[A-Z* a-z*]{1,20}" title="Enter Subject5, MAX 20"></td>
            <tr>
            <td>Marks:<input type="text"  id="mrk5" name="mrk5" required pattern="[0-9*]{1,3}" title="Enter Marks between 0-100"></td>
            </tr>
            <tr>
            <td>Subject 6:<input type="text"  id="sub6" name="sub6"></td>
            <tr>
            <td>Marks:<input type="text"  id="mrk6" name="mrk6" required pattern="[0-9]{0,3}" title="Enter Marks between 0-100"></td>
            </tr>
            <tr>
            <td>Subject 7:<input type="text"  id="sub7" name="sub7"></td>
            <tr>
            <td>Marks:<input type="text"  id="mrk7" name="mrk7"></td>
            </tr>
            <tr>
            <td>Subject 8:<input type="text"  id="sub8" name="sub8"></td>
            <tr>
            <td>Marks:<input type="text"  id="mrk8" name="mrk8"></td>
            </tr>
            <tr>
            <td>Subject 9:<input type="text"  id="sub9" name="sub9"></td>
            <tr>
            <td>Marks:<input type="text"  id="mrk9" name="mrk9" minlength="0" maxlength="12" title="Enter Marks between 0-100"></td>
            </tr> 
        </table>
